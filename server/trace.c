...
static void dump_init_system_dir_request( const struct init_system_dir_request *req )
{
    dump_varargs_unicode_str( " sysdir=", cur_size );
}
...
static const dump_func req_dumpers[REQ_NB_REQUESTS] = {
    ...
    (dump_func)dump_init_system_dir_request,
